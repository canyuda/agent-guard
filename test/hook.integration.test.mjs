...
const testEnv = (mock) => {
  ...
  writeFileSync(cfgPath, JSON.stringify({ ...BASE_CFG, degrade_ask_to_deny: true, log: { enabled: true, path: join(dir, "a.jsonl") }, cache: { ...BASE_CFG.cache, path: join(dir, "cache.json") } }));
